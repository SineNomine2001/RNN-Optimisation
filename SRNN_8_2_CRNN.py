...
from keras.layers import Input, Embedding, GRU, TimeDistributed, Dense, Conv1D, MaxPooling1D
import codecs
...
gru1 = GRU(NUM_FILTERS,recurrent_activation='sigmoid',activation=None,return_sequences=False)(maxConv1)
...
gru2 = GRU(NUM_FILTERS,recurrent_activation='sigmoid',activation=None,return_sequences=False)(maxConv2)
...
maxConv3 = MaxPooling1D(pool_length=2)(conv3)
gru3 = GRU(NUM_FILTERS,recurrent_activation='sigmoid',activation=None,return_sequences=False)(maxConv3)
