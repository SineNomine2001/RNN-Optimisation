...
dot1 = TimeDistributed(SDot(NUM_FILTERS, kernel_regularizer=l2(4e-6), kernel_constraint=maxnorm(10)))(embed1)
gru1 = SRU(NUM_FILTERS)(dot1)
Encoder1 = Model(input1, gru1)

input2 = Input(shape=(16,int(MAX_LEN/16)), dtype='int32')
embed2 = TimeDistributed(Encoder1)(input2)
dot2 = TimeDistributed(SDot(NUM_FILTERS, kernel_regularizer=l2(4e-6), kernel_constraint=maxnorm(10)))(embed2)
gru2 = SRU(NUM_FILTERS)(dot2)
...
best_model= load_model(savebestmodel, custom_objects={'SDot': SDot, 'SRU': SRU})
