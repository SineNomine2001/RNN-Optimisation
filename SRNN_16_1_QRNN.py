...
dot1 = TimeDistributed(QDot(NUM_FILTERS, kernel_regularizer=l2(4e-6), kernel_constraint=maxnorm(10), zoneout=zn_rate))(embed1)
gru1 = QRNN(NUM_FILTERS)(dot1)
Encoder1 = Model(input1, gru1)

input2 = Input(shape=(16,int(MAX_LEN/16)), dtype='int32')
embed2 = TimeDistributed(Encoder1)(input2)
dot2 = TimeDistributed(QDot(NUM_FILTERS, kernel_regularizer=l2(4e-6), kernel_constraint=maxnorm(10), zoneout=zn_rate))(embed2)
gru2 = QRNN(NUM_FILTERS)(dot2)
...
best_model= load_model(savebestmodel, custom_objects={'QDot': QDot, 'QRNN': QRNN})
