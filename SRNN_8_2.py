...
gru1 = GRU(NUM_FILTERS,recurrent_activation='sigmoid',activation=None,return_sequences=False,dropout=dp)(embed1)
Encoder1 = Model(input1, gru1)

input2 = Input(shape=(8,int(MAX_LEN/64),), dtype='int32')
embed2 = TimeDistributed(Encoder1)(input2)
gru2 = GRU(NUM_FILTERS,recurrent_activation='sigmoid',activation=None,return_sequences=False,dropout=dp)(embed2)
Encoder2 = Model(input2, gru2)

input3 = Input(shape=(8,8,int(MAX_LEN/64)), dtype='int32')
embed3 = TimeDistributed(Encoder2)(input3)
gru3 = GRU(NUM_FILTERS,recurrent_activation='sigmoid',activation=None,return_sequences=False,dropout=dp)(embed3)
